...
export class FamilyMemberService {
    ...
    async create(beneficiaryId: string, createFamilyMemberDto: CreateFamilyMemberDto) {
        ...
        if (existingMember) throw new ConflictException('Family Member Is Already Exists');
    ...
    async update(id: string, updateFamilyMemberDto: UpdateFamilyMemberDto) {
        ...
        if (updateFamilyMemberDto.nationalId) {
            ...
            if (existingMember) throw new ConflictException('This national id is Already Exists');
