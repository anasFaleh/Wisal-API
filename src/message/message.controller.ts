...
export class MessagesController {
  ...
  @Roles(Emp.ADMIN, Emp.DISTRIBUTER)
  @ApiOperation({
    summary: 'Get all messages for an institution (Admin, Distributer)',
  })
  ...
  @Roles(Emp.ADMIN, Emp.DISTRIBUTER)
  @ApiOperation({
    summary: 'Change Message Status To Sent (Admin, Distributer)',
  })
  @ApiParam({ name: 'id', description: 'Message ID (UUID)' })
  ...
  @Roles(Emp.ADMIN, Emp.DISTRIBUTER)
  @ApiOperation({
    summary: 'Get statistics for a message (Admin, Distributer)',
  })
  @ApiParam({ name: 'id', description: 'Message ID (UUID)' })
  @ApiResponse({
    status: 200,
