...
export class DistributionController {
  ...
  @ApiResponse({ status: 200, description: 'Distribution returned successfully' })
  ...
  @ApiResponse({ status: 200, description: 'List of distributions returned successfully' })
  ...
  @ApiResponse({ status: 404, description: 'Distribution not found' })
  update(@Param('id', new ParseUUIDPipe()) id: string, @Body() dto: UpdateDistributionDto) {
  ...
  @ApiParam({ name: 'id', description: 'Distribution ID (UUID)' })
  @ApiResponse({ status: 200, description: 'Distribution deleted successfully' })
  @ApiResponse({ status: 404, description: 'Distribution not found' })
